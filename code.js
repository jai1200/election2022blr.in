       ...
       let a=document.getElementById("na").value;
        ...
        for (i = 0; i < x.length; i++) {
           ...
           // console.log("this is new"+z+"Second-"+y);
            ...
            ccc=x[i].getElementsByTagName('code') [0].childNodes[0].nodeValue;
            ...
            for(i=0; i<x.length;i++)
            {
                ...
                if(r===x[i].getElementsByTagName('center')[0].childNodes[0].nodeValue&&ccc===x[i].getElementsByTagName('code')[0].childNodes[0].nodeValue)
                {
        ...
        else if(match==1&&cname.substring(0,6)=="हे0का0"||match==1&&cname.substring(0,3)=="का0")
        {
