       ...
       let a=document.getElementById("na").value;
        ...
        for (i = 0; i < x.length; i++) {
           ...
           // console.log("this is new"+z+"Second-"+y);
            ...
            q=x[i].getElementsByTagName('code') [0].childNodes[0].nodeValue;
            ...
            var capf=x[i].getElementsByTagName('capf')[0].childNodes[0].nodeValue;
            var bus=x[i].getElementsByTagName('bus')[0].childNodes[0].nodeValue;
            var cname=x[i].getElementsByTagName('hgname')[0].childNodes[0].nodeValue+" "+
                      x[i].getElementsByTagName('hgoffice')[0].childNodes[0].nodeValue+" "+
                      x[i].getElementsByTagName('hgdis')[0].childNodes[0].nodeValue+" मो0 "+
                      x[i].getElementsByTagName('hgmob')[0].childNodes[0].nodeValue+" ";
            ...
            for(i=0; i<x.length;i++)
            {
                ...
                if(r===x[i].getElementsByTagName('center')[0].childNodes[0].nodeValue&&q===x[i].getElementsByTagName('code') [0].childNodes[0].nodeValue)
                {
        ...
        if(match==1&&cname.substring(0,5)=='उ0नि0')
        {
            ...
            diff.style['backgroundColor']="pink";
            document.getElementById('y').innerHTML="";
        }
        else if(match==1&&cname.substring(0,3)=='का0'||cname.substring(0,6)=='हे0का0')
        {
            cells[0].innerHTML=co;
            cells[1].innerHTML=cname;
            cells[2].innerHTML=ce;
            ...
            //var tab=document.getElementById('tab');
            tab.style['display']="table";
            diff.style['backgroundColor']="#90ee90";
            document.getElementById('y').innerHTML="";

        }
        else if(match==1&&cname.substring(0,6)=='हो0गा0')
        {
            cells[0].innerHTML=co;
            cells[1].innerHTML=cname;
            cells[2].innerHTML=ce;
            ...
            //var tab=document.getElementById('tab');
            tab.style['display']="table";
            diff.style['backgroundColor']="white";
            document.getElementById('y').innerHTML="";
